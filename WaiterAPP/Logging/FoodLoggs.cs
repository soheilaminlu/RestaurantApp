...
{
    public partial class FoodLoggs
    {
        [LoggerMessage(EventId = 1, Level = LogLevel.Error, Message = "init")]


        [LoggerMessage(EventId = 2, Level = LogLevel.Error, Message = "init")]
        ...
        [LoggerMessage(EventId = 7, Level = LogLevel.Information, Message = "init")]
